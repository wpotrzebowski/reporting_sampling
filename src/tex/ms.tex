...
Additionally, it is valuable to report statistics, such as a Gelman-Rubin statistic \cite{gelman_inference_1992}, that describes any convergence analysis that has been performed on the chains.
